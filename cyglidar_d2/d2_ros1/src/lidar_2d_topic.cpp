...
void Lidar2dTopic::initPublisher(ros::Publisher publisher_laserscan, ros::Publisher publisher_point_2d)
{
...
{
    _message_point_cloud_2d = std::make_shared<sensor_msgs::PointCloud2>();
...
void Lidar2dTopic::publishPoint2D(ros::Time start_time)
{
...
{
    _message_laserscan = std::make_shared<sensor_msgs::LaserScan>();
...
void Lidar2dTopic::publishScanLaser(ros::Time start_time, uint16_t* distance_buffer_2d)
{
    uint8_t buffer_index = 0;
